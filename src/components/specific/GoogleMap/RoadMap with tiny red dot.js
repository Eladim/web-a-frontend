      ...
      >
        {directionsResponse && (
          <>
            ...
            {path.length > 0 && (
              <Circle
                center={path[currentPositionIndex]}
                radius={300} // Larger radius for the outer ring
                options={{
                  fillColor: 'transparent', // Transparent fill
                  strokeColor: '#FF0000',
                  strokeOpacity: 0.8,
                  strokeWeight: 5, // Thicker stroke for visibility
                }}
              />
            )}
            ...
            {path.length > 0 && (
              <Circle
                center={path[currentPositionIndex]}
                radius={150} // Smaller radius for the inner circle
                options={{
                  fillColor: '#FF0000',
                  fillOpacity: 0.8,
                  strokeColor: 'transparent', // No stroke for the inner circle
                }}
              />
            )}
          </>
