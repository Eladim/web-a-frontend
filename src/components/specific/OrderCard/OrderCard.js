    ...
    >
      ...
      <div className={styles.orderDetails}>
        ...
        <p><strong>Commission Free: </strong>
          <FontAwesomeIcon
            icon={order.is_commission_free ? faCheck : faTimes}  // Checkmark for true, Cross for false
            className={order.is_commission_free ? styles.customCheckIcon : styles.crossIcon}
          />
        </p>
