...
const Sidebar = ({ actions, isAdmin }) => {
  const [isOpen, setIsOpen] = useState(false);
  const navigate = useNavigate(); // Initialize useNavigate to handle redirects
  ...
  const handleSignOut = () => {
    ...
    const logoutMessage = logoutService();
    console.log(logoutMessage); // Optionally log the message
